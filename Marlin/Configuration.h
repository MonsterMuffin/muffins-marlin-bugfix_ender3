...
#define STRING_CONFIG_H_AUTHOR "(Muffin's Print)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 37.06
    #define DEFAULT_Ki 4.45
    #define DEFAULT_Kd 77.08
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 161.20
  #define DEFAULT_bedKi 31.48
  #define DEFAULT_bedKd 550.24
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -2, -4.15 }
